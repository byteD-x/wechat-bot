...
| --- | --- | --- | --- |
| `GET` | `/api/auth/providers` | `get_auth_providers_api` | `backend/api.py:2712` |
| `POST` | `/api/auth/providers/<provider_key>/cancel` | `cancel_auth_provider_flow` | `backend/api.py:2736` |
| `POST` | `/api/auth/providers/<provider_key>/logout_source` | `logout_auth_provider_source` | `backend/api.py:2767` |
| `POST` | `/api/auth/providers/<provider_key>/start` | `start_auth_provider_flow` | `backend/api.py:2721` |
| `POST` | `/api/auth/providers/<provider_key>/submit_callback` | `submit_auth_provider_callback` | `backend/api.py:2751` |
...
| `GET` | `/api/config` | `get_config` | `backend/api.py:2808` |
| `POST` | `/api/config` | `save_config` | `backend/api.py:2849` |
| `GET` | `/api/config/audit` | `get_config_audit` | `backend/api.py:2820` |
...
| `GET` | `/api/costs/review_queue_export` | `export_cost_review_queue` | `backend/api.py:2659` |
| `GET` | `/api/costs/session_details` | `get_cost_session_details` | `backend/api.py:2639` |
| `GET` | `/api/costs/sessions` | `get_cost_sessions` | `backend/api.py:2623` |
| `GET` | `/api/costs/summary` | `get_costs_summary` | `backend/api.py:2607` |
...
| `GET` | `/api/evals/latest` | `get_latest_eval_report` | `backend/api.py:2538` |
...
| `POST` | `/api/knowledge_base/auto-index/jobs` | `create_knowledge_base_auto_index_job` | `backend/api.py:2227` |
| `GET` | `/api/knowledge_base/auto-index/preview` | `preview_knowledge_base_auto_index` | `backend/api.py:2213` |
| `POST` | `/api/knowledge_base/batch-dry-run` | `preview_knowledge_base_documents` | `backend/api.py:2293` |
| `POST` | `/api/knowledge_base/batch-ingest` | `ingest_knowledge_base_documents` | `backend/api.py:2364` |
| `POST` | `/api/knowledge_base/batch-rebuild` | `rebuild_knowledge_base_documents` | `backend/api.py:2399` |
| `POST` | `/api/knowledge_base/delete` | `delete_knowledge_base_document` | `backend/api.py:2497` |
| `POST` | `/api/knowledge_base/dry-run` | `preview_knowledge_base_document` | `backend/api.py:2278` |
| `GET` | `/api/knowledge_base/index` | `get_knowledge_base_index` | `backend/api.py:2170` |
| `POST` | `/api/knowledge_base/ingest` | `ingest_knowledge_base_document` | `backend/api.py:2441` |
| `POST` | `/api/knowledge_base/jobs` | `create_knowledge_base_job` | `backend/api.py:2308` |
| `GET` | `/api/knowledge_base/jobs/<job_id>` | `get_knowledge_base_job` | `backend/api.py:2349` |
| `POST` | `/api/knowledge_base/rebuild` | `rebuild_knowledge_base_document` | `backend/api.py:2447` |
| `GET` | `/api/knowledge_base/status` | `get_knowledge_base_status` | `backend/api.py:2143` |
| `GET` | `/api/logs` | `get_logs` | `backend/api.py:3137` |
| `POST` | `/api/logs/clear` | `clear_logs` | `backend/api.py:3181` |
...
| `POST` | `/api/model_auth/action` | `post_model_auth_action` | `backend/api.py:2697` |
| `GET` | `/api/model_auth/overview` | `get_model_auth_overview` | `backend/api.py:2688` |
| `GET` | `/api/model_catalog` | `get_model_catalog_api` | `backend/api.py:2678` |
| `GET` | `/api/ollama/models` | `get_ollama_models` | `backend/api.py:2782` |
...
| `POST` | `/api/preview_prompt` | `preview_prompt` | `backend/api.py:3056` |
| `GET` | `/api/pricing` | `get_pricing` | `backend/api.py:2581` |
| `POST` | `/api/pricing/refresh` | `refresh_pricing` | `backend/api.py:2592` |
...
| `POST` | `/api/test_connection` | `test_connection` | `backend/api.py:3030` |
| `GET` | `/api/usage` | `get_usage` | `backend/api.py:2570` |
| `GET` | `/api/v1/admin/prompts/<int:revision>/diff` | `diff_prompt_revision` | `backend/api.py:2942` |
| `POST` | `/api/v1/admin/prompts/<int:revision>/rollback` | `rollback_prompt_revision` | `backend/api.py:2957` |
| `GET` | `/api/v1/admin/prompts/revisions` | `list_prompt_revisions` | `backend/api.py:2931` |
