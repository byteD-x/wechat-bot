export const MESSAGE_TEXT = {
    ...
    contactPromptEditable: '回复风格规则',
    contactPromptFixed: '固定注入块（只读）',
    contactPromptEmpty: '还没有回复风格规则。先根据画像补充一句“怎么回这个人”，再保存。',
    ...
    contactPromptSave: '保存风格规则',
    contactPromptSaveSuccess: '回复风格规则已保存',
    contactPromptSaveFailed: '保存回复风格规则失败',
    contactPromptFixedHint: '这里只写你想额外约束的回复方式。历史对话、联系人画像、时间和情绪会在运行时自动补齐。',
    firstValueTitle: '首个价值闭环',
    firstValueSummary: '先确认这个联系人是谁、怎么回，再审阅草稿。默认不需要全自动发送。',
    firstValueProfileStep: '1. 看画像和历史风格',
    firstValuePromptStep: '2. 补一句回复规则',
    firstValueApprovalStep: '3. 审阅草稿后再发送',
    firstValueFeedbackStep: '4. 对已发送回复标记有帮助或没帮助',
